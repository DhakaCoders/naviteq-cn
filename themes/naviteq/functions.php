...
Constants->>
*/
defined('THEME_NAME') or define('THEME_NAME', 'naviteq');
...
if( !function_exists('cbv_theme_setup') ){
    ...
    function cbv_theme_setup(){
      ...
      load_theme_textdomain( 'naviteq', get_template_directory() . '/languages' );
...
if( function_exists('acf_add_options_page') ) { 
    ...
    acf_add_options_page(array(
        'page_title'    => __('Options', 'naviteq'),
        'menu_title'    => __('Options', 'naviteq'),
